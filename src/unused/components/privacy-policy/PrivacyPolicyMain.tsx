              ...
              <div className="tab-content mb-60">
                ...
                >
                  <div className="terms_conditions_content">
                    ...
                    <p>
                      At Ecomart, we are committed to providing you with a
                      seamless shopping experience. However, {`it's`} essential
                      to understand our limitations and responsibilities. Please
